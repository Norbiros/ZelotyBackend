...
export default class CalendarCommand extends Command {
    ...
    constructor() {
        super();
        this.description = 'Dowiedz się jaki jest dzisiaj dzień w Starowiańskim kalendarzu.';
        this.style = false;
    }
    ...
    async execute(): Promise<EmbedBuilder> {
        ...
        return new EmbedBuilder()
            ...
            .setDescription('Kalendarz rozpoczął się 2 lutego 2022 roku. Rok słada się z 3 tecji. Tecja składa się z 9 dni.')
            .addFields(
                {
                    name: 'Dzień',
                    value: `${day}`
